...
class NeuralNet(object):
    ...
    '''
    def __init__(self,input_size,output_size,hidden_layers_sizes,neurons_type='sigmoid',alpha=0.0001,regularization=False):
        '''
        :param input_size: int, size of an input
        :param output_size: int, size of an output
        :param hidden_layers_sizes: list of int, size of each hidden layer
...
class Neuron(object):
    ...
    def activation(self,input_values=[]): #if BIAS neuron, won't have input_values (input_values = weights * activations)
        '''
    ...
    def delta(self): #TODO
        '''
        WILL need input values (the weights, deltas and activations) (slide 56 aula 11)
